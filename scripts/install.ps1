try {
    ...
    # $scriptUrl = "https://raw.githubusercontent.com/FatGrizzly/jiotv_go/main/scripts/install.ps1"
    ...
    $binaryUrl = "https://github.com/FatGrizzly/jiotv_go/releases/latest/download/jiotv_go-windows-$arch.exe"
