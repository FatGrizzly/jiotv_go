...
| -------------- | ------------------ | ---------------------------------------------------------------------------------------------------------------------- |
| Android        | arm64 (aarch64)    | [jiotv_go-android-arm64](https://github.com/FatGrizzly/jiotv_go/releases/latest/download/jiotv_go-android-arm64)         |
| Android        | amd64 (x86_64)     | [jiotv_go-android-amd64](https://github.com/FatGrizzly/jiotv_go/releases/latest/download/jiotv_go-android-amd64)         |
| Android        | arm                | [jiotv_go-android-arm](https://github.com/FatGrizzly/jiotv_go/releases/latest/download/jiotv_go-android-arm)             |
| Linux          | arm64 (aarch64)    | [jiotv_go-linux-arm64](https://github.com/FatGrizzly/jiotv_go/releases/latest/download/jiotv_go-linux-arm64)             |
| Linux          | amd64 (x86_64)     | [jiotv_go-linux-amd64](https://github.com/FatGrizzly/jiotv_go/releases/latest/download/jiotv_go-linux-amd64)             |
| Linux          | arm                | [jiotv_go-linux-arm](https://github.com/FatGrizzly/jiotv_go/releases/latest/download/jiotv_go-linux-arm)                 |
| Linux          | 386 (x86, i686)    | [jiotv_go-linux-386](https://github.com/FatGrizzly/jiotv_go/releases/latest/download/jiotv_go-linux-386)                 |
| Windows        | 386 (x86, i686)    | [jiotv_go-windows-386.exe](https://github.com/FatGrizzly/jiotv_go/releases/latest/download/jiotv_go-windows-386.exe)     |
| Windows        | amd64 (x86_64)     | [jiotv_go-windows-amd64.exe](https://github.com/FatGrizzly/jiotv_go/releases/latest/download/jiotv_go-windows-amd64.exe) |
| Windows        | arm64 (aarch64)    | [jiotv_go-windows-arm64.exe](https://github.com/FatGrizzly/jiotv_go/releases/latest/download/jiotv_go-windows-arm64.exe) |
| Darwin (macOS) | amd64 (x86_64)     | [jiotv_go-darwin-amd64](https://github.com/FatGrizzly/jiotv_go/releases/latest/download/jiotv_go-darwin-amd64)           |
| Darwin (macOS) | arm64 (aarch64)    | [jiotv_go-darwin-arm64](https://github.com/FatGrizzly/jiotv_go/releases/latest/download/jiotv_go-darwin-arm64)           |
...
```sh
docker run -p 5001:5001 -e TZ=Asia/Kolkata -e JIOTV_DRM=true -e JIOTV_PATH_PREFIX=/app/.jiotv_go -v jiotv_go:/app/.jiotv_go ghcr.io/FatGrizzly/jiotv_go
```
...
services:
  jiotv_go:
    image: ghcr.io/FatGrizzly/jiotv_go
    ports:
      - "5001:5001"
    volumes:
...
If you're impatient for new features, to get unstable build, use the `ghcr.io/FatGrizzly/jiotv_go:develop` image.
...
```sh
docker run -p 8080:8080 -v jiotv_go:/app/secrets ghcr.io/FatGrizzly/jiotv_go serve --public --port 8080
```
...
```sh
docker pull ghcr.io/FatGrizzly/jiotv_go:latest
```
