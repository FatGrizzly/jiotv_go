...
```bash
curl -LO jiotv_go --progress-bar "https://github.com/FatGrizzly/jiotv_go/releases/latest/download/jiotv_go-android-{arch}"
```
...
```bash
curl -LO jiotv_go --progress-bar "https://github.com/FatGrizzly/jiotv_go/releases/latest/download/jiotv_go-linux-{arch}"
```
