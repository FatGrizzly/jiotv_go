...
**Linux/macOS:**
```bash
git clone https://github.com/FatGrizzly/jiotv_go.git
cd jiotv_go
```
...
Found a pesky bug? No worries! Please help us improve JioTV Go by creating an issue [here](https://github.com/FatGrizzly/jiotv_go/issues/new). Be sure to include detailed steps to reproduce the bug, describe the expected behavior, and, if possible, attach screenshots. Your feedback is invaluable!
