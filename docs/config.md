...
The file is also available at [configs/jiotv-config.toml](https://github.com/FatGrizzly/jiotv_go/blob/main/configs/jiotv-config.toml).
...
The file is also available at [configs/jiotv-config.yml](https://github.com/FatGrizzly/jiotv_go/blob/main/configs/jiotv-config.yml).
...
The file is also available at [configs/jiotv-config.json](https://github.com/FatGrizzly/jiotv_go/blob/main/configs/jiotv-config.json).
